...
object FilterResource {
  ...
  def apply(whitelistIps: Set[String], blacklistIps: Set[String], whitelistHosts: Set[String], blacklistHosts: Set[String]): FilterResource = {
    new FilterResource(whitelistIps, blacklistIps, whitelistHosts, blacklistHosts)
  }
}
